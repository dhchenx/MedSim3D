...
if __name__=="__main__":
    ...
    detect_edges(img_path=image_path,save_path='datasets/evaluate1/canny_'+file_name)
    time1=time.time()
    # Using Canny algorithm with polygons
    detect_edges_with_polygon(img_path=image_path, save_path='datasets/evaluate1/canny2_' + file_name)
    time2=time.time()
    # Using single-color isolate algorithm
    isolate_image(image_path=image_path,save_path='datasets/evaluate1/iso_'+file_name)
    time3=time.time()
    # Using multi-color isolate algorithm
    isolate_image2(image_path=image_path, save_main_color='datasets/evaluate1/iso2c_' + file_name, save_path='datasets/evaluate1/iso2_' + file_name)
    time4=time.time()
