...
class ObjRawParser:
    ...
    def parse(self,to_triangle_mesh=False):
        # obj_file="models/male.obj"
        fobj=open(self.model_file,'r')
...
if __name__=="__main__":
    obj_parser=ObjRawParser(model_file="models/earth.obj")
    ...
    # Example 2:
    obj_parser.save_to_off(save_off_file='outputs/earth.off')
    Viewer3D().show_object(obj_file="outputs/earth.off")
