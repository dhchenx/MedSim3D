...
netlogo.command('set scale 3')
netlogo.command('set sample-rate 1')
netlogo.command('set size-scale 2')
netlogo.command(f'load-obj-file-common "models/teapot.obj" true')
